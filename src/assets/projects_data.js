...
const projects_data = [
    ...
    },
    {
        ...
        p_img: project4_img,
        description: "Balıkesir Yeniçayırhisar kavşağı için çalıştığım projede, trafik akışını iyileştirmek amacıyla sinyalize trafik ışığı sistemi modellemesi ve simülasyonu yaptım. Gerçek verilerle araç yoğunluğu ve bekleme süreleri analiz edilerek, farklı ışıklandırma senaryolarının etkilerini değerlendirdim.",
