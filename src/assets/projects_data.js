...
const projects_data = [
    ...
    },
    {
        ...
        p_img: project3_img,
        description: "SolidWorks ile tasarlanan elma ambalaj hattı, dizim, karton yerleştirme, kapak kapama ve etiketleme gibi temel işlemleri içeren verimli bir sistemdir. Amaç, süreci hızlandırarak iş gücü verimliliğini artırmaktır.",
        tools: ["SOLIDWORKS"]
    },
    {
        p_no: 4,
        ...
        p_img: project4_img,
        description: "Balıkesir Yeniçayırhisar kavşağı için yapılan projede, trafik akışını iyileştirmek amacıyla sinyalize trafik ışığı sistemi modellemesi ve simülasyonu yapılmıştır. Gerçek verilerle araç yoğunluğu ve bekleme süreleri analiz edilerek, farklı ışıklandırma senaryolarının etkileri değerlendirilmiştir.",
    ...
    },
    {
        ...
        p_img: project6_img,
        description: "Ergonomi dersi kapsamında, çelik fabrikasında ergonomik risk değerlendirmesi gerçekleştirildi. REBA metodunun uygulanması için CATIA’daki dijital insan modelleme aracıyla çalışma duruşları simüle edildi. Mevcut durum analiz edilerek, çalışan konforunu artırmak amacıyla yenilikçi paketleme makinesi tasarlandı.",
